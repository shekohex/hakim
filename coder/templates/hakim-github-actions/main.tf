...
module "proliferate" {
  ...
  source = "https://github.com/shekohex/proliferate/releases/download/coder-module-v0.1.5/proliferate-terraform-module.tgz//coder/modules/proliferate"
  ...
  group                     = null
  subdomain                 = true
  release_ref               = length(data.coder_parameter.proliferate_release_ref) > 0 ? data.coder_parameter.proliferate_release_ref[0].value : "coder-module-v0.1.5"
