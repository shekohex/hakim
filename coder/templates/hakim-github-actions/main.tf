...
data "coder_parameter" "github_actions_repository" {
  name         = "github_actions_repository"
  display_name = "Actions Repository"
  description  = "GitHub repository containing the Hakim workspace workflow."
  default      = "shekohex/hakim"
  mutable      = true
  type         = "string"
  icon         = "/icon/git.svg"
  order        = 4
...
data "coder_parameter" "github_actions_workflow_file" {
  name         = "github_actions_workflow_file"
  display_name = "Workflow File"
  description  = "Workflow file path inside the actions repository."
  default      = ".github/workflows/hakim-workspace.yml"
  mutable      = true
  type         = "string"
  icon         = "/icon/git.svg"
  order        = 5
...
data "coder_parameter" "github_actions_workflow_ref" {
  name         = "github_actions_workflow_ref"
  display_name = "Workflow Ref"
  description  = "Branch, tag, or SHA used when dispatching the workflow."
  default      = "main"
  mutable      = true
  type         = "string"
  icon         = "/icon/git.svg"
...
data "coder_parameter" "actions_age_public_key" {
  ...
  description  = "age recipient used to encrypt workflow manifests for the control repository."
  default      = ""
  mutable      = true
  type         = "string"
  icon         = "/icon/git.svg"
...
module "proliferate" {
  ...
  source = "https://github.com/shekohex/proliferate/releases/download/coder-module-v0.1.3/proliferate-terraform-module.tgz//coder/modules/proliferate"
  ...
  group                     = null
  subdomain                 = true
  release_ref               = length(data.coder_parameter.proliferate_release_ref) > 0 ? data.coder_parameter.proliferate_release_ref[0].value : "coder-module-v0.1.3"
